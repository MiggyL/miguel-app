    ...
    <div className="min-h-screen bg-[#F0F4F8] text-[#1f1f1f]">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mt-8 bg-white rounded-2xl p-6 border border-gray-200 shadow-sm">
          <h3 className="text-xl font-bold text-gray-900 mb-6">Powered By:</h3>
          
          {/* AI / Models / Assistants */}
          <div className="mb-6">
            <h4 className="text-lg font-semibold text-gray-800 mb-3">AI / Models / Assistants:</h4>
            <div className="flex flex-wrap gap-3">
              <div className="flex items-center gap-2 px-4 py-2 bg-gray-50 rounded-full border border-gray-200 hover:bg-gray-100 transition-colors">
                <img src="/chatgpt_icon.png" alt="ChatGPT" className="w-5 h-5" />
                <span className="text-sm font-medium text-gray-700">ChatGPT</span>
              </div>
              <div className="flex items-center gap-2 px-4 py-2 bg-gray-50 rounded-full border border-gray-200 hover:bg-gray-100 transition-colors">
                <img src="/claude_icon.png" alt="Claude" className="w-5 h-5" />
                <span className="text-sm font-medium text-gray-700">Claude</span>
              </div>
              <div className="flex items-center gap-2 px-4 py-2 bg-gray-50 rounded-full border border-gray-200 hover:bg-gray-100 transition-colors">
                <img src="/llama_icon.png" alt="Llama 3.3" className="w-5 h-5" />
                <span className="text-sm font-medium text-gray-700">Llama 3.3</span>
              </div>
              <div className="flex items-center gap-2 px-4 py-2 bg-gray-50 rounded-full border border-gray-200 hover:bg-gray-100 transition-colors">
                <img src="/gemma_icon.png" alt="Gemma 3" className="w-5 h-5" />
                <span className="text-sm font-medium text-gray-700">Gemma 3</span>
              </div>
              <div className="flex items-center gap-2 px-4 py-2 bg-gray-50 rounded-full border border-gray-200 hover:bg-gray-100 transition-colors">
                <img src="/mistral_icon.png" alt="Mistral Large" className="w-5 h-5" />
          ...
          {/* Voice / Avatar / Video */}
          <div className="mb-6">
            <h4 className="text-lg font-semibold text-gray-800 mb-3">Voice / Avatar / Video:</h4>
            <div className="flex flex-wrap gap-3">
              <div className="flex items-center gap-2 px-4 py-2 bg-gray-50 rounded-full border border-gray-200 hover:bg-gray-100 transition-colors">
                <img src="/elevenlabs_icon.png" alt="ElevenLabs" className="w-5 h-5" />
                <span className="text-sm font-medium text-gray-700">ElevenLabs</span>
              </div>
              <div className="flex items-center gap-2 px-4 py-2 bg-gray-50 rounded-full border border-gray-200 hover:bg-gray-100 transition-colors">
                <img src="/sora_icon.png" alt="Sora 2" className="w-5 h-5" />
                <span className="text-sm font-medium text-gray-700">Sora 2</span>
              </div>
              <div className="flex items-center gap-2 px-4 py-2 bg-gray-50 rounded-full border border-gray-200 hover:bg-gray-100 transition-colors">
                <img src="/capcut_icon.png" alt="CapCut" className="w-5 h-5" />
                <span className="text-sm font-medium text-gray-700">CapCut</span>
              </div>
              <div className="flex items-center gap-2 px-4 py-2 bg-gray-50 rounded-full border border-gray-200 hover:bg-gray-100 transition-colors">
                <img src="/pippit_icon.png" alt="Pippit" className="w-5 h-5" />
          ...
          {/* Dev / Hosting / Infra */}
          <div className="mb-6">
            <h4 className="text-lg font-semibold text-gray-800 mb-3">Dev / Hosting / Infra:</h4>
            <div className="flex flex-wrap gap-3">
              <div className="flex items-center gap-2 px-4 py-2 bg-gray-50 rounded-full border border-gray-200 hover:bg-gray-100 transition-colors">
              ...
              <div className="flex items-center gap-2 px-4 py-2 bg-gray-50 rounded-full border border-gray-200 hover:bg-gray-100 transition-colors">
                <img src="/vercel_icon.png" alt="Vercel" className="w-5 h-5" />
                <span className="text-sm font-medium text-gray-700">Vercel</span>
              </div>
              <div className="flex items-center gap-2 px-4 py-2 bg-gray-50 rounded-full border border-gray-200 hover:bg-gray-100 transition-colors">
                <img src="/netlify_icon.png" alt="Netlify" className="w-5 h-5" />
                <span className="text-sm font-medium text-gray-700">Netlify</span>
              </div>
              <div className="flex items-center gap-2 px-4 py-2 bg-gray-50 rounded-full border border-gray-200 hover:bg-gray-100 transition-colors">
                <img src="/render_icon.png" alt="Render" className="w-5 h-5" />
                <span className="text-sm font-medium text-gray-700">Render</span>
              </div>
              <div className="flex items-center gap-2 px-4 py-2 bg-gray-50 rounded-full border border-gray-200 hover:bg-gray-100 transition-colors">
                <img src="/cloudflare_icon.png" alt="Cloudflare" className="w-5 h-5" />
          ...
          {/* IDE */}
          <div>
            <h4 className="text-lg font-semibold text-gray-800 mb-3">IDE:</h4>
            <div className="flex flex-wrap gap-3">
              <div className="flex items-center gap-2 px-4 py-2 bg-gray-50 rounded-full border border-gray-200 hover:bg-gray-100 transition-colors">
                <img src="/kiro_icon.png" alt="Kiro" className="w-5 h-5" />
